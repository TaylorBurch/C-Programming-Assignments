...
namespace TaylorBurchPA5
{
	class Payment
	{
		public static void inputPaymentMethod()
		{
		...
		{
			long userCardNum = 0;
			Console.WriteLine("Please enter the full card number.");
		...
		static public void getFinalValidation(long oddTotal, long evenTotal)
		{
			...
			if (sumTotal % 10 == 0)
			{
				...
				Console.WriteLine("Congrats, this listing is officially yours!");
				Console.WriteLine("Please exit the payment system. Thank you!");
				Console.ReadKey();
			}
			else
			{
				...
				Console.WriteLine("Please contact Rent My Place to resolve this issue.");
				Console.ReadKey();
			}
		}
